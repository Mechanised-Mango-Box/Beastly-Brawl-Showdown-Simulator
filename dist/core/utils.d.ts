 ...
 */
export type LookupTable<ACCEPTED_KEYS extends PropertyKey, DISCRIMINANT_NAME extends PropertyKey, VALUE extends {
    [K in DISCRIMINANT_NAME]: PropertyKey;
}> = {
    [ROW_KEY in ACCEPTED_KEYS]: VALUE & {
        [K in DISCRIMINANT_NAME]: ROW_KEY;
    };
};
export declare function log_notice(val: any): void;
export declare function log_warning(val: any): void;
export declare function log_attention(val: any): void;
export declare function log_event(val: any): void;
