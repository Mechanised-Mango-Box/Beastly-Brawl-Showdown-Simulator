...
export type ChooseMove = BaseNotice<"chooseMove", {
    moveIdOptions: EntryID[];
}, (moveId: EntryID, targetingData: TargetingData) => void>;
export type Roll = BaseNotice<"roll", {
    diceFaces: number;
}, () => void>;
export type RerollOption = BaseNotice<"rerollOption", {
    diceFaces: number;
}, (shouldReroll: boolean) => void>;
export {};
